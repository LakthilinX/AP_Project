                ...
                <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="100">
                  <div>
                    <div class="card" style="width: 18rem;">
                      ...
                      <div class="card-body">
                        <a href="IndexServlet?action=loadJob&id=<c:out value='${consultant.getConsultantId()}' />&country=<c:out value='${consultant.getCountry()}' />&name=<c:out value='${consultant.getFname()} ${consultant.getLname()}' />"
